...
def abc(lista):
    ...
    with ConnectHandler(**lista) as net_connect:
...
with concurrent.futures.ThreadPoolExecutor(max_workers=cantidad_dispositivos) as executor:
    executor.map(abc, lista)
